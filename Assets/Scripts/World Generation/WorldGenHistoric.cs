...
public class WorldGenHistoric : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector3 Ve = new Vector3(minX + (sizeX)/2f -0.5f, 0f, minZ +(sizeZ)/2f -0.5f); // -0.5 since the int are at the center of the block
